            ...
            <div align="center" style="padding-top:100px;">
                <table>
                    ...
                    <tr style="background-color: #ffd9e6;" align="center" >
                        <td style="padding:10px;color:rgb(112, 10, 24);">{{ $doctor->name }}</td>
                        <td style="padding:10px;color:rgb(112, 10, 24);">{{ $doctor->phone }}</td>
                        <td style="padding:10px;color:rgb(112, 10, 24);">{{ $doctor->speciality }}</td>
                        <td style="padding:10px;color:rgb(112, 10, 24);">{{ $doctor->room }}</td>
                        <td> <img src="{{ $doctor->image }}"width="220px"height="200px"> </td>
                        <td> <a onclick="return confirm('Are you sure to delete this ?')" href="{{url('delete_doc',$doctor->id)}}" class="btn btn-danger">delete</td>
                        <td> <a href="{{url('update_doc',$doctor->id)}}" class="btn btn-warning">update</td>
